...
@Slf4j
@Component
public class ResidentBot extends TelegramLongPollingBot {

    @Value("${bot_resident.name}")
    @Getter
    ...
    @Value("${bot_resident.token}")
    @Getter
    private String botToken;

    public ResidentBot(UserRepository userRepository, List<Handler> handlerList, InlineLocationModeService inlineLocationMode) {
